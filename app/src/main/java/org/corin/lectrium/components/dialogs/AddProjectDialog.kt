...
fun AddProjectDialog(
    ...
    onSaveProject: (Project, String) -> Unit
) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Team Members / Group Name") },
                modifier = Modifier.fillMaxWidth()
            )
                    ...
                    onClick = {
                        if (title.isNotBlank()) {
                            val project = Project(
                                ...
                                deadlineTimestamp = System.currentTimeMillis() + (7 * 24 * 60 * 60 * 1000L),
                                teamMembers = teamMembers
                            )
                            onSaveProject(project, selectedCourse?.code ?: "Course")
                            onDismissRequest()
                        }
                    }
                ) {
